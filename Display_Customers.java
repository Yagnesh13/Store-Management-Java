...
public class Display_Customers extends JFrame {
    private JTable table;
    private JTextField textField;
    
    public static void main(String[] args){		 
	new Display_Customers().setVisible(true);    
    }
	...
	JLabel Fcode = new JLabel("Customer ID");
	Fcode.setFont(new Font("Tahoma", Font.PLAIN, 17));
        Fcode.setBounds(50, 100, 200, 30);
	add(Fcode);
	
		
	JLabel CustDetails = new JLabel("CUSTOMERS INFORMATION");
	...
	btnShow.setFont(new Font("Tahoma", Font.PLAIN, 20));
        ...
        btnShow.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent ae) {
                ...
                try {
                    conn c = new conn();
                    String str = "select * from customer where cid = '"+code+"'";
	...
	btnShowAll.setFont(new Font("Tahoma", Font.PLAIN, 20));
        ...
        btnShowAll.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent ae) {	
                ...
                try {
                    conn c = new conn();
                    String str1 = "select * from customer order by cid asc";
